...
#ifndef PARALLELGRAPH_DENSE_BITSET_HPP
#define PARALLELGRAPH_DENSE_BITSET_HPP
...
namespace parallelgraph {
  ...
  */
  ...
  public:
	...
	inline void assign(const dense_bitset other) {
    assert(size() == other.size());
		memcpy(array, other.array, sizeof(size_t) * arrlen);
	}
